...
SELECT * FROM accounts -- SELECT first to check if data I want to change is right
WHERE account_balance = 0 AND transactions_attempted = 0;

UPDATE accounts -- Updating above selection to reflect change.
...
VALUES ('darian', 'minneapolis', 1, 1, 999999.99);
